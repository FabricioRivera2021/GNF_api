...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Estados::factory()->create(['estados' => 'sin atender', 'active' => 1]);
        \App\Models\Estados::factory()->create(['estados' => 'en ventanilla', 'active' => 1]);
        \App\Models\Estados::factory()->create(['estados' => 'en preparacion', 'active' => 1]);
        \App\Models\Estados::factory()->create(['estados' => 'para pagar', 'active' => 1]);
        \App\Models\Estados::factory()->create(['estados' => 'para entregar', 'active' => 1]);
        \App\Models\Estados::factory()->create(['estados' => 'pausado', 'active' => 1]);
        \App\Models\Estados::factory()->create(['estados' => 'cancelado', 'active' => 1]);
        \App\Models\Estados::factory()->create(['estados' => 'finalizado', 'active' => 1]);
